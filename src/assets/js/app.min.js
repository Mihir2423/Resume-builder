/*
Template Name: Ipseity - Admin
Author: abiliquest
Version: 1.0.0
Website: https://abiliquest.com/
Contact: support@abiliquest.com
    ...
    */
    ...
    App.prototype.init = function () {
        ...
        if (window.sessionStorage && bodyConfig && bodyConfig.hasOwnProperty('showRightSidebarOnPageLoad') && bodyConfig['showRightSidebarOnPageLoad']) {
            var alreadyVisited = sessionStorage.getItem("_Ipseity_VISITED_");
            if (!alreadyVisited) {
                $.RightBar.toggleRightSideBar();
                sessionStorage.setItem("_Ipseity_VISITED_", true);
            }
        }
